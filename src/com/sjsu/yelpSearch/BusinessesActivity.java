...
public class BusinessesActivity extends ListActivity {
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		System.out.println("Hello I m here : "+mBusinesses.get(position).getLocation().getLongitude());
		intent.putExtra(BusinessActivity.EXTRA_BUSINESS, mBusinesses.get(position));
//		System.out.println(":::::::::::"+mBusinesses.get(position).getImageUrl());
//		System.out.println(":::::::::::"+mBusinesses.get(position).mLocation.mLongitude);
